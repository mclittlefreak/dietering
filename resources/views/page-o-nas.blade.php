...
<div class="">
    @layouts('Sekcja')
      <div class="pt-4 mx-auto w-10/12 flex flex-col md:flex-row justify-between items-center">
  ...
  <div class="">
    @layouts('o_firmie')
      <div class="md:mt-[93px] mt-4 mx-auto w-10/12  flex-col-reverse md:flex-row flex">
  ...
  <div class=" w-full bg-[#E7F3ED] flex py-4 md:p-0 mt-14 justify-end relative mb-8 md:h-[417px]">
        ...
        <div class=" lg:mx-0 mx-auto w-10/12 md:w-[53%] md:pt-[62px] pt-4 flex flex-col justify-start group" >
          <div class="">
