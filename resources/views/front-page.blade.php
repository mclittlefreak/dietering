...
@section('content') 
    ...
    <div class="flex flex-wrap w-10/12 mx-auto">
      ...
      <div class="w-full">
        <div class="md:h-[548px] h-[285px] w-full bg-cover bg-no-repeat block group" style="background-image: url({{ wp_get_attachment_image_src(get_sub_field('img'), 'large')[0] }})">
          <div class="flex flex-col justify-end sm:w-1/2 md:w-[60%] w-10/12 mx-auto ml-[7%] md:pt-[87px] pt-4">
  ...
  <div class="">
    ...
    <div id="diety" class="swiper w-10/12 mx-auto">
  ...
  <div class=" lg:mt-[70px] lg:mt-12 mt-6">
    <div class="container pb-8">
      ...
      <div class=" mt-8 w-10/12 mx-auto ">
    <div class=" pb-8">
      ...
      <div class="flex justify-center">
        <a href="{{ get_post_type_archive_link('blog') }}" class="flex items-center mt-8 duration-150 bg-[#028523] p-4 rounded-full hover:bg-[#2d2d2d]">
